...
export class PartnersPage implements OnInit, OnDestroy {
  ...
  constructor(private partnerService: PartnerService, private navCtrl: NavController,private loadingCtrl: LoadingController, private uiService: UIService,private modalCtrl: ModalController) { }
